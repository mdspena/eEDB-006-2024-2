CREATE EXTERNAL TABLE `inep2022_json`(
  `nu_ano_censo` int, 
  `no_regiao` string, 
  `co_regiao` int, 
  `no_uf` string, 
...
WITH SERDEPROPERTIES ( 
  'path'='s3://eedb-006-2024-2-grupo-2/benchmark/eedb_006/inep2022_json') 
LOCATION
  's3://eedb-006-2024-2-grupo-2/benchmark/eedb_006/inep2022_json'